...
export class OlvidoContrasena2Component {
  ...
  onSubmit(): void {
    ...
    console.log('Email:', this.codigo);
     //ESTO HABRIA Q BORRARLO, SOLO PARA PASAR AHORA DE PAGINA MIENTRAS NO ESTE LA API
     this.router.navigate(['/olvidoContrasena3']);
    ...
    this.http.post('https://mi_api/login', { email: this.codigo})
    .subscribe({
